...
class MobAboutWidget extends StatefulWidget {
  const MobAboutWidget({super.key});

  @override
  State<MobAboutWidget> createState() => _MobAboutWidgetState();
}

class _MobAboutWidgetState extends State<MobAboutWidget> {
  List social = [];
  @override
